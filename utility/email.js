              ...
              <tr>
                <td style="padding: 0 40px 20px;">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td align="center">
                        <a href="http://localhost:3000/profile" style="display: inline-block; background: #dc2626; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: bold;">Explore Your Profile</a>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td style="padding: 20px 40px; border-top: 1px solid rgba(255, 255, 255, 0.1);">
                  ...
                  <p style="color: #71717a; font-size: 10px; margin: 0;">
                    © 2025 Inspira. All rights reserved. | <a href="http://localhost:3000/privacy" style="color: #a1a1aa; text-decoration: none;">Privacy Policy</a> | <a href="http://localhost:3000/terms" style="color: #a1a1aa; text-decoration: none;">Terms of Service</a>
                  </p>
                </td>
              </tr>
            </table>
              ...
              <tr>
                <td style="padding: 0 40px 20px;">
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td align="center">
                        <a href="http://localhost:3000/login" style="display: inline-block; background: #dc2626; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: bold;">Log In Now</a>
                      </td>
                    </tr>
                  </table>
                </td>
